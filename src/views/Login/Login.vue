<template>
  <main class="tw-flex tw-h-full tw-items-center tw-justify-center tw-gap-5">
    ...
    <VCard class="tw-h-full tw-w-full tw-max-w-[40rem] tw-flex-col tw-flex tw-justify-center tw-align-center"
      ...
      <div class="tw-text-sm tw-opacity-75 tw-self-center tw-text-center tw-cursor-pointer tw-underline">
        Acessar sem login
      </div>
    </VCard>
  </main>
